...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CHANNEL_ID = "Camera channel";
        ...
        button.setOnClickListener(v -> {
            NotificationCompat.Builder builder =
                    new NotificationCompat.Builder(MainActivity.this, CHANNEL_ID)
                            ...
                            .setContentText("Дрига Демид В. ИКБО-11-20")
                            .setStyle(new NotificationCompat.BigTextStyle());

            NotificationManagerCompat notificationManager1 =
                    NotificationManagerCompat.from(MainActivity.this);
            Random random = new Random();
            notificationManager1.notify(random.nextInt(), builder.build());
        });

        mTextureView = findViewById(R.id.textureView);

    }
    //callback from CameraDevice
